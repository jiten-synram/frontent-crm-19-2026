    ...
    <div>
      <div className="flex items-start justify-between mb-5">
        ...
        <div className="flex gap-2">
          ...
          <button className="btn btn-outline btn-sm text-xs" onClick={() => reportsAPI.export({ format: 'excel', ...filters })}>↓ Excel</button>

          <button className="btn btn-outline btn-sm text-xs" onClick={() => reportsAPI.export({ format: 'csv', ...filters })}>↓ CSV</button>
        </div>
      </div>
